...
const Page = () => {
        return ( <
            ...
            <
            div className = "text-black" > { " " } { /* profile Tap */ } { " " } {
                true && ( <
                    >
                    <
                    EditProfile / >
            ...
            } { /* Photo Tap */ } { false === "Photo" && < EditPhoto / > } { /* Close account Tap */ } { " " } { false === "Close account" && < CloseAccount / > } { /* Privacy Tap  */ } { " " } {
                false === "Privacy" && ( <
                    >
                    <
                    ...
                    <
                    input type = "checkbox"
                    defaultChecked className = "peer h-5 w-5 cursor-pointer transition-all appearance-none  shadow hover:shadow-md border border-slate-300 checked:bg-slate-800 checked:border-slate-800"
                    id = "check-2" /
                    >
                    <
                    ...
                    /span>{" "} <
                    /label>{" "} <
                    label className = "cursor-pointer ml-3 text-lg leading-tight tracking-tight peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                    htmlFor = "check-2" >
                    Show your profile to logged - in users { " " } <
                    /label>{" "} <
                    /div>{" "} { /* Show courses you're taking on your profile page */ } { " " } <
