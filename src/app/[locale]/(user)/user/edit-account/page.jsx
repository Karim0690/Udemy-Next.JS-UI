    ...
    const showToast = (message, isError = false) => {
        const toastId = toast("", {
            description: ( <
                ...
                /div> <
                button className = "mt-5 mx-14 bg-gray-800 text-white w-20 p-3"
                onClick = {
    ...
    return ( <
        ...
        /div> {
            pageIsLoading ? ( <
                ...
                p >
                For your security,
                if you change your email address your saved credit card information will be deleted. <
                /p> <
                /div> <
                ...
                < /label> <
                input className = "appearance-none block w-full text-gray-700 border border-black py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                id = "current-password"
                type = "password"
                name = "oldPassword"
                ...
                <
                button className = "bg-zinc-800 text-white hover:bg-zinc-700 p-3 font-bold my-6"
                onClick = {
                    () => {
