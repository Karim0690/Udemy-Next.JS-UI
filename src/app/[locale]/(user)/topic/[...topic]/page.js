...
const Page = ({ params }) => {
    ...
    return ( <
        ...
        span className = "text-base font-bold text-[#5022C3] hover:cursor-pointer hover:text-[#503392]" > { t("development") } <
        /span> <
        span className = "text-base font-bold text-[#5022C3] hover:cursor-pointer hover:text-[#503392]" > , <
        /span> <
        span className = "text-base font-bold text-[#5022C3] hover:cursor-pointer hover:text-[#503392]" > { t("it_software") } <
        /span> <
        /div> <
        div className = "text-sm font-bold text-gray-600 mt-2" > < /div> <
        div className = "mt-16" >
        <
        h3 className = "font-bold text-2xl text-gray-800 mb-2" > { t("courses_to_get_started") } <
        /h3> <
        ...
        <
        span className = "capitalize" > { topic } < /span> { t("students_also_learn") } <
        /h3> <
        TopicsSlider / >
        <
        /div> <
        div className = "mx-12 mt-12 mb-12" >
        <
        h3 className = "font-bold text-2xl text-gray-800 mb-4" > { t("top_courses_in") } < span className = "capitalize" > { topic } < /span> { t("and") } <
        span className = "font-bold text-[#5022C3] underline underline-offset-4 hover:cursor-pointer hover:text-[#5a39a7]" > { t("jquery") } <
        /span> <
        /h3> <
        CoursesSlider / >
        <
        ...
        div className = "mx-12 mt-12 mb-12" >
        <
        h3 className = "font-bold text-2xl text-gray-800 mb-4" > { t("top") } < span className = "capitalize" > { topic } < /span> { t("courses_in") } <
        span className = "font-bold text-[#5022C3] underline underline-offset-4 hover:cursor-pointer hover:text-[#5a39a7]" > { t("programming_languages") } <
        /span> <
        /h3> <
        CoursesSlider / >
        <
        /div> { /* Popular Instructor*/ } <
        div className = "mx-12 mt-12 mb-12" >
        <
        h3 className = "font-bold text-2xl text-gray-800 mb-2" > { t("popular_instructor") } <
        /h3> <
        ...
        div className = "mx-12 mt-12 mb-12" >
        <
        h3 className = "font-bold text-2xl text-gray-800 mb-2" > { t("all") } < span className = "capitalize" > { topic } < /span> { t("courses") } <
        /h3> <
        p className = "text-gray-800 text-base mb-2 w-[60%]" > { t("join_learners") } <
        /p> <
        /div> { /* Course Cards */ } <
        div className = "mx-12 mt-12 mb-12" >
        <
        ...
        <
        IoIosInformationCircle style = {
            { fontSize: "32px" } }
        /> <
        p className = "font-bold text-base text-gray-800 ml-6" > { t("not_sure") } <
        /p> <
        /div> <
        ...
        name = "sort"
        required className = "block w-full px-2 pt-5 text-base focus:outline-none bg-transparent text-gray-800" >
        <
