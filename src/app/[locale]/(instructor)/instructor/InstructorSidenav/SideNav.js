          ...
          <ul className="w-full">
            <div className="hover:bg-[#3e4143]">
              <li className=" p-5 w-max">
                <Link href={`${locale}/instructor/course`}>
                  <div
                    className={`relative after:content-[''] after:block after:absolute after:top-0 after:left-[1rem] after:h-[2.5rem] after:w-[28.1rem] after:bg-[#2d2f31] after:opacity-100`}
                    style={{
            ...
            >
              ...
              >
                ...
                <span
                  className={`ml-4 font-bold text-white relative after:content-[''] after:block after:absolute ${
                    locale === "ar"
        ...
        {path.split("/")[2] == "communication" ? (
          <div className="fixed w-72 top-0 left-0 h-screen text-gray-800 bg-gray-100">
            <ul className="ml-24 my-10 sticky">
              <li
                className={`my-5 ${path.split("/")[3] == "qa" && "font-bold"}`}
              >
