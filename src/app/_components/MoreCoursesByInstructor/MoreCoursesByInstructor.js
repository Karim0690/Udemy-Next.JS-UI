      ...
      <div className="mt-9">
        ...
        <div className="flex space-x-6 border-b-2 border-gray-300 mb-9 pb-9 mt-7">
          {repeatedCourses.map((co, index) => (
            <div key={index} className="  shadow-md rounded-lg  w-full">
              <img
                src={co.courseImg}
                alt={co.title}
              ...
              <div className="ml-1">
                ...
                <p className=" text-slate-400 text-sm">
                  {convertDurationToDecimal(course.duration)} total hours •{" "}
                  {course.numberOfLecture} • All Levels{" "}
                </p>
                <p className="font-semibold  text-lg mt-4 text-slate-700">
                  {" "}
