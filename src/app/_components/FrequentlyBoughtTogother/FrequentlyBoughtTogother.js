  ...
  return (
    <div className="my-5 border-2 p-4">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex">
                ...
                <div className="flex flex-col ml-3 w-60">
                  <h3 className="text-md w-80 font-bold text-slate-800 ">
                    {course.title}
                  </h3>
                  ...
                  <div className="flex items-center">
                    ...
                    <Rating
                      ...
                      readOnly={true}
                      className="mt-9 bg-[#B56B11]"
                    />
                    <a className="mr-3 ml-4 text-stone-400 font-semibold">
                      ({course.enrollments})
                    </a>
                  </div>
                </div>
      ...
      <div className="flex justify-between items-center mt-5">
        ...
        <Button className="bg-[#A435F0] hover:bg-[#8710D8] text-white font-bold p-7">
          Add all to cart
        </Button>
      </div>
    </div>
