  ...
  return (
    <>
      <div
        ...
        className={`${openSection ? "hidden" : ""} group z-[6] bg-[#2D2F31] text-center  h-full flex justify-center items-center text-white w-16 hover:w-40 transition-all duration-300`}
      >
        <FaArrowLeft />
      ...
      <SidebarProvider
        className={`${openSection ? "" : "hidden"} h-fulleeeeee `}
      >
        <div className="flex flex-col">
          <div
            className={` bg-white h-7 w-72 pt-2  pb-11  border-t-neutral-950 border-1 px-5`}
          >
                  ...
                  <CollapsibleContent>
                    <SidebarMenuSub className="px-4 py-2">
                      <SidebarMenuSubItem className="flex items-center space-x-2 py-2 text-gray-700">
                        ...
                        <span>
                          394. Thank You and Please Leave a Rating for the
                          course
                        </span>
