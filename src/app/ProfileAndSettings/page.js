                  ...
                  <form>
                    <div class="flex flex-wrap -mx-3 mb-6">
                      ...
                      <div className="w-full md:w-1/2 px-3 mt-6 md:mb-0">
                        ...
                        <div class="flex items-center space-x-1 rtl:space-x-reverse sm:pe-4 border border-black ">
                          <button
                            type="button"
                            class="p-2 text-black focus:bg-black focus:text-white  font-bold"
                          >
                            B
                          </button>
                          <button
                            type="button"
                            class="p-2 text-black focus:bg-black focus:text-white font-bold italic "
                          >
                            I
                          </button>
                        </div>
                        ...
                        <textarea
                          id="editor"
                          rows="8"
                          class="block w-full px-0 text-sm border border-black text-black bg-white "
                          required
                        ></textarea>
                        <div className="text-gray-400 font-normal text-xs mt-2">
                          ...
                          Personality. Your biography should have at least 50
                          words, links and coupon codes are not permitted.
                        </div>
                      </div>
                      <div className="w-full md:w-1/2 px-3 mt-6 md:mb-0">
                        <label
